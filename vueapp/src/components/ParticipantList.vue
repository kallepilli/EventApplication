        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr v-for="eventParticipant in eventParticipants" :key="eventParticipant.id">
                    ...
                    <td>
                        <button @click="updateParticipant(eventParticipant.id)" class="btn btn-secondary btn-sm">Muuda</button>
                        <button @click="deleteParticipant(eventParticipant.id)" class="btn btn-danger btn-sm" style="margin-left:3px;">Kustuta osaleja</button>
                    </td>
                </tr>
            </tbody>
        </table>
...
<script setup lang="ts">
    ...
    const props = defineProps({ participantsUpdated: Boolean, isPastEvent: Boolean });
